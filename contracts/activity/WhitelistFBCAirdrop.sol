...
interface ACycleWhitelistInterface {
...
contract ACycleWhitelistAirdrop is Operator {
    address public fbcAddress;
    IBEP20 public fbcContract;

    address public whitelistAddress;
    ACycleWhitelistInterface public whitelist;

    constructor(address _fbc, address _whitelist) {
        fbcAddress = _fbc;
        whitelistAddress = _whitelist;

        whitelist = ACycleWhitelistInterface(whitelistAddress);

        fbcContract = IBEP20(fbcAddress);
    }
